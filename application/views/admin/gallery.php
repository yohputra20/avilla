        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold" style="color:#18011B;">Data Gallery</h6>
              <a href="#" class="btn btn-success" id="galleryAdd">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i = 1; foreach($galley_data['query'] as $row): ?>
                    <tr>   
                        ...
                        <td width="30%"><img class="imagesize" src="<?php echo base_url('assets/admin/upload/gallery/'. $row['image']);?>" /></td>
                        <td width="25%"><?php echo $row['description']; ?></td>
                        <td align="center" width="10%">
                          <button id="galleryEdit" style="width:80px;" class="btn btn-warning margin5" data-value="<?php echo $row['id']; ?>">
                              Edit
                          </button>
                          <button id="galleryDelete" style="width:80px;" class="btn btn-danger margin5" data-value="<?php echo $row['id']; ?>">
                              Delete
                          </button>
                        </td>
                    </tr>
