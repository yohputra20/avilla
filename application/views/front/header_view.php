  ...
  <header id="header" class="header" style="padding-bottom:0;border-bottom:#919191;">
                                  ...
                                  <li <?php if($menu_active == "product") {echo 'class="active dropdown"';}?>>
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                          <a class="dropdown-item"
                                              href="<?php echo base_url();?>detail-produk/product/genset">Heavy Duty
                                              Genset</a>
                                          <a class="dropdown-item"
      ...
      <div class="container"
          style="background-color:#919191; color:white;border-bottom:#919191; margin:0 !important;width:100%">
          <div class="row">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-3 col-sm-3 col-3 text-center"
                                              ...
                                              <i class="fa fa-phone"></i>&nbsp;<a
                                                  href="tel:+622152394859">021-52394859</a>
                                          </div>
                                          <div class="col-md-4 col-sm-4 col-5 text-left" style="padding-left:0px">
                                              <i class="fa fa-phone"></i> <i class="fa fa-whatsapp"></i>&nbsp;<a
                                                  ...
                                                  target="_blank">0813-9041-1533</a>
                                          </div>
                                      </div>
