                                ...
                                <div class="single-blog detailblog">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <?php if ($row['path_logo'] != "") { ?>
                                            <img src="<?php echo base_url() . "assets/admin/upload/product/" . $row['path_logo']; ?>" style="height:80px" alt="<?php if (isset($row['meta_title'])) {
                                                                                                                                                                }; ?>">
                                        <?php } else { ?>
                                            <img src="<?php echo base_url() . "assets/front/images/no_image.png"; ?>" style="height:80px" alt="<?php if (isset($row['meta_title'])) {
                                                                                                                                                    echo $row['meta_title'];
                                                                                                                                                }; ?>">
                                        <?php } ?>
                                    </div>
